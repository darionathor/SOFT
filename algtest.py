...
for num in range(0,10):
    ...
    while (1):
        ...
        if(nr_objectsl1>0):
            line1[0]=(objectsl1[0][1].start,objectsl1[0][0].stop)
            line1[1]=(objectsl1[0][1].stop,objectsl1[0][0].start)

        labeledl2, nr_objectsl2 = ndimage.label(imgl2)
        objectsl2 = ndimage.find_objects(labeledl2)
